...
parser.add_argument("--results_csv", type=str, default="/home/sjoshi/spuco_experiments/celeba/jtt.csv")
...
parser.add_argument("--upsample_factor", type=int, default=50)
...
trainer = Trainer(
    ...
    optimizer=SGD(model.parameters(), lr=1e-5, weight_decay=1e-1, momentum=args.momentum),
    device=device,
    verbose=True
)
...
with open("celeba_jtt_group_partition.pkl", "wb") as f:
